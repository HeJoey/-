...
struct task_manager_t {
	...
	/**
	 * Queue IKE_SA init phase only tasks.
	 */
	void (*queue_ike_init_only)(task_manager_t *this);

	/**
	 * Queue IKE_SA auth phase only tasks.
	 */
	void (*queue_ike_auth_only)(task_manager_t *this);

	/**
	 * Set phase separation mode.
	 *
	 * @param init_only		TRUE to enable init-only mode
	 * @param auth_only		TRUE to enable auth-only mode
	 */
	void (*set_phase_separation_mode)(task_manager_t *this, bool init_only, bool auth_only);
